...
check(/V2\.73 · Goal Path Intelligence/.test(html) && /Finish line:/.test(html) && /Average measurable progress/.test(html), 'Audited goal cards must expose finish lines and exclude non-measurable roadmap modes from averages.');

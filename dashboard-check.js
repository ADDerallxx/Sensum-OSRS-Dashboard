...
check(/V2\.72b · True Blockers/.test(html) && /Finish line:/.test(html) && /Average measurable progress/.test(html), 'Audited goal cards must expose finish lines and exclude non-measurable roadmap modes from averages.');

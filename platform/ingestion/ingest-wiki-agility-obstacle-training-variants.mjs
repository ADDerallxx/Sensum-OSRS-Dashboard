...
const report=audit(records,{minimum:2,required:['parent_name','variant_key','name','entry_level','xp_per_success','failure_free_level','observed_xp_per_hour','source_revision','source_locator'],maximumUnknownRatio:0});

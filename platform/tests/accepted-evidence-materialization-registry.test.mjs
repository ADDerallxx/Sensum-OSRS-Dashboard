...
test('registry exposes all accepted evidence adapters and rejects unknown domains',()=>{
  assert.deepEqual(acceptedEvidenceDomains(),['activity-candidate-source-evidence','activity-canonical-subject-scope-evidence','activity-infobox-schema-semantics-evidence','activity-reference-collection-member-canonical-activity-identity-evidence','activity-reference-collection-member-canonical-activity-subject-declaration-exact-line-evidence','activity-reference-collection-member-canonical-activity-subject-declaration-structural-context-evidence','activity-reference-collection-member-collection-activity-identity-evidence','activity-reference-collection-member-independent-repeatability-signal-scope-evidence','activity-reference-collection-member-independent-repeatability-signal-subject-predicate-evidence','activity-reference-collection-member-independent-repeatability-source-evidence','activity-reference-collection-member-repeatability-evidence','activity-reference-collection-member-repeatability-gap-evidence','activity-reference-collection-member-source-evidence','activity-reference-collection-member-unresolved-subject-relationship-evidence','cross-skill-untyped-page-source-evidence','skill-level-unlock-inventory','weighted-parent-task-entry-membership-evidence']);

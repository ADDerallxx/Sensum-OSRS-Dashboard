...
test('registry exposes all accepted evidence adapters and rejects unknown domains',()=>{
  assert.deepEqual(acceptedEvidenceDomains(),['activity-candidate-source-evidence','activity-canonical-subject-scope-evidence','activity-infobox-schema-semantics-evidence','activity-reference-collection-member-canonical-activity-identity-evidence','activity-reference-collection-member-canonical-activity-subject-declaration-exact-line-evidence','activity-reference-collection-member-canonical-activity-subject-declaration-structural-context-evidence','activity-reference-collection-member-collection-activity-identity-evidence','activity-reference-collection-member-independent-repeatability-signal-scope-evidence','activity-reference-collection-member-independent-repeatability-signal-subject-predicate-evidence','activity-reference-collection-member-independent-repeatability-source-evidence','activity-reference-collection-member-repeatability-evidence','activity-reference-collection-member-repeatability-gap-evidence','activity-reference-collection-member-source-evidence','activity-reference-collection-member-unresolved-subject-relationship-evidence','cross-skill-untyped-page-source-evidence','exact-scoped-independent-repeatability-evidence','skill-level-unlock-inventory','weighted-parent-task-entry-membership-evidence']);
  ...
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-repeatability-gap-evidence').dataFile,'activity-reference-collection-member-repeatability-gap-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-repeatability-gap-evidence').factKind,'raw_activity_reference_member_repeatability_gap_evidence');
  assert.equal(getAcceptedEvidenceAdapter('activity-infobox-schema-semantics-evidence').dataFile,'activity-infobox-schema-semantics-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('activity-infobox-schema-semantics-evidence').factKind,'raw_activity_infobox_schema_semantics_evidence');
  assert.equal(getAcceptedEvidenceAdapter('cross-skill-untyped-page-source-evidence').dataFile,'cross-skill-untyped-page-source-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('cross-skill-untyped-page-source-evidence').factKind,'raw_cross_skill_untyped_page_source_evidence');
  assert.equal(getAcceptedEvidenceAdapter('exact-scoped-independent-repeatability-evidence').dataFile,'exact-scoped-independent-repeatability-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('exact-scoped-independent-repeatability-evidence').factKind,'raw_exact_scoped_independent_repeatability_evidence');
  ...
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-canonical-activity-subject-declaration-structural-context-evidence').dataFile,'activity-reference-collection-member-canonical-activity-subject-declaration-structural-context-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-canonical-activity-subject-declaration-structural-context-evidence').factKind,'raw_activity_reference_member_canonical_activity_subject_declaration_structural_context_evidence');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-independent-repeatability-signal-scope-evidence').dataFile,'activity-reference-collection-member-independent-repeatability-signal-scope-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-independent-repeatability-signal-scope-evidence').factKind,'raw_activity_reference_member_independent_repeatability_signal_scope_evidence');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-independent-repeatability-signal-subject-predicate-evidence').dataFile,'activity-reference-collection-member-independent-repeatability-signal-subject-predicate-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-independent-repeatability-signal-subject-predicate-evidence').factKind,'raw_activity_reference_member_independent_repeatability_signal_subject_predicate_evidence');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-independent-repeatability-source-evidence').dataFile,'activity-reference-collection-member-independent-repeatability-source-evidence.ndjson');
  assert.equal(getAcceptedEvidenceAdapter('activity-reference-collection-member-independent-repeatability-source-evidence').factKind,'raw_activity_reference_member_independent_repeatability_source_evidence');

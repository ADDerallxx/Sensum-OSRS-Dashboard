...
check(conditionVariant.rules.levelSpecificRatesCannotBeInterpolated===true&&conditionVariant.rules.baseAndEffectiveLevelsMustRemainSeparate===true&&conditionVariant.rules.zeroEntryLevelMeansNoSkillAccessRequirement===true&&conditionVariant.rules.equipmentAndDiaryEffectsMustRemainIndependent===true&&conditionVariant.rules.pillarObstacleAndTicketExperienceMustRemainSeparate===true,'Compound conditions must preserve access, modeled level, equipment, diary, and reward boundaries.');

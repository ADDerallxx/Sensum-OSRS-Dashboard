...
check(golden.timingPolicy.boundedCycleRangesCannotBecomePointEstimates===true&&golden.timingPolicy.observedPeakTimingCannotBecomeTypicalTiming===true&&golden.timingPolicy.timeBasedCompletionOutcomesMayOmitRandomFailureRoll===true&&golden.timingPolicy.unknownRandomFailureStateRemainsNull===true,'Golden timing must preserve ranges, peaks, deterministic completion outcomes, and unknown failure state.');

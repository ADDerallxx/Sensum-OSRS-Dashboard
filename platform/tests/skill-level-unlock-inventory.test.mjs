...
check(record.sourceBulletCount===6&&record.capturedStatementCount===6,'Every source bullet, including consecutive and inline entries, must be captured exactly once.');
...
check(audit.statementCoverage.capturedStatementCount===144&&audit.statementCoverage.countsMatch,'Aggregate source and captured statement counts must match.');

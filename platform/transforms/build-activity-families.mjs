...
const parseFragment=(fragment,row,targetSkill)=>{
  ...
  if((m=text.match(/(?:at level|level of|requires level)\s*(\d+)\s*(?:\[\[[^\]]+\]\]\s*)?(?:and higher|or higher|to access|required)?/i)))push('level_requirement','constraint',{minimum:number(m[1])},m);

...
import { buildHistoricalAttributionApplications } from './cross-skill-rendered-page-without-unlock-evidence-historical-attribution-application-lib.mjs';
...
const policyFile = 'platform/policies/cross-skill-rendered-page-without-unlock-evidence-historical-attribution-application-v1.json';
...
const decisionPolicyFile = 'platform/policies/cross-skill-rendered-page-without-unlock-evidence-historical-attribution-review-decision-import-v1.json';
...
if (!queueDirectory || !decisionDirectory) {
  console.log(JSON.stringify({
    contract: 'sensum.cross-skill-rendered-page-without-unlock-evidence-historical-attribution-application-audit.v1',
    accepted: false,
  ...
  try {
    ...
    const built = buildHistoricalAttributionApplications({
    ...
    const inputs = {
      queue: { directory: queue.directory, contentHash: queue.contentHash, createdAt: queue.createdAt },
    ...
    if (!built.audit.publishable) {
      ...
      const source = {
        kind: 'explicit_human_decision_bound_historical_attribution_application_without_downstream_semantic_or_optimizer_promotion',
      ...
      console.log(JSON.stringify({
        ...
        coverage: {
          ...
          confirmedApplicationCount: report.applicationCoverage.confirmedApplicationCount,
          rejectedUnappliedCount: report.applicationCoverage.rejectedUnappliedCount,
          evidenceUnavailableUnappliedCount: report.applicationCoverage.evidenceUnavailableUnappliedCount,
          ...
          historicalAttributionApplicationComplete: report.historicalAttributionApplicationComplete,

...
const [sections,candidates,rooftopMemberCoverage,brimhavenMemberCoverage,hallowedMemberCoverage,rockslideMemberCoverage]=await Promise.all([
...
const memberAudits=[reportMemberAudit(rooftopMemberCoverage),reportMemberAudit(brimhavenMemberCoverage),reportMemberAudit(hallowedMemberCoverage),reportMemberAudit(rockslideMemberCoverage)].filter(Boolean);
...
report.snapshotRejections=[...sections.rejections,...candidates.rejections,...rooftopMemberCoverage.rejections,...brimhavenMemberCoverage.rejections,...hallowedMemberCoverage.rejections,...rockslideMemberCoverage.rejections];

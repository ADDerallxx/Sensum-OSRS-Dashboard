...
const [sections,candidates,rooftopMemberCoverage,brimhavenMemberCoverage,hallowedMemberCoverage,rockslideMemberCoverage,colossalWyrmMemberCoverage]=await Promise.all([
  ...
  latestReport('agility-hallowed-guide-member-coverage-audits','sensum.agility-hallowed-guide-member-coverage-audit.v1'),
  latestReport('agility-rockslide-guide-member-coverage-audits','sensum.agility-rockslide-guide-member-coverage-audit.v1'),
  latestReport('agility-colossal-wyrm-guide-member-coverage-audits','sensum.agility-colossal-wyrm-guide-member-coverage-audit.v1')
]);
...
const memberAudits=[reportMemberAudit(rooftopMemberCoverage),reportMemberAudit(brimhavenMemberCoverage),reportMemberAudit(hallowedMemberCoverage),reportMemberAudit(rockslideMemberCoverage),reportMemberAudit(colossalWyrmMemberCoverage)].filter(Boolean);
...
report.inputSnapshots={
  ...
  hallowedMemberCoverage:hallowedMemberCoverage.report?{directory:hallowedMemberCoverage.directory,contentHash:hallowedMemberCoverage.report.contentHash,complete:hallowedMemberCoverage.report.internalMemberAuditSatisfied}:null,
  rockslideMemberCoverage:rockslideMemberCoverage.report?{directory:rockslideMemberCoverage.directory,contentHash:rockslideMemberCoverage.report.contentHash,complete:rockslideMemberCoverage.report.internalMemberAuditSatisfied}:null,
  colossalWyrmMemberCoverage:colossalWyrmMemberCoverage.report?{directory:colossalWyrmMemberCoverage.directory,contentHash:colossalWyrmMemberCoverage.report.contentHash,complete:colossalWyrmMemberCoverage.report.internalMemberAuditSatisfied}:null
};
report.snapshotRejections=[...sections.rejections,...candidates.rejections,...rooftopMemberCoverage.rejections,...brimhavenMemberCoverage.rejections,...hallowedMemberCoverage.rejections,...rockslideMemberCoverage.rejections,...colossalWyrmMemberCoverage.rejections];

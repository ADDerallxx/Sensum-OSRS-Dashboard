...
const [sections,candidates,rooftopMemberCoverage,brimhavenMemberCoverage,hallowedMemberCoverage]=await Promise.all([
...
const memberAudits=[reportMemberAudit(rooftopMemberCoverage),reportMemberAudit(brimhavenMemberCoverage),reportMemberAudit(hallowedMemberCoverage)].filter(Boolean);
...
report.snapshotRejections=[...sections.rejections,...candidates.rejections,...rooftopMemberCoverage.rejections,...brimhavenMemberCoverage.rejections,...hallowedMemberCoverage.rejections];

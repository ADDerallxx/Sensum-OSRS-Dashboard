...
export const isReviewableObservedBenchmark=variant=>variant?.observational_benchmark_only===true&&variant?.outcome_integrated_in_observed_rate===true&&finite(variant?.observed_xp_per_hour)!==null&&finite(variant?.observed_xp_per_hour_level_scope?.minimum)!==null&&finite(variant?.observed_xp_per_hour_level_scope?.maximum)!==null&&finite(variant?.observed_xp_per_hour_level_scope?.minimum)<=finite(variant?.observed_xp_per_hour_level_scope?.maximum)&&!!variant?.observed_rate_source_revision&&!!variant?.observed_rate_source_locator&&!!variant?.source_revision&&!!variant?.source_locator;

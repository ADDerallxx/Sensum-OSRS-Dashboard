...
import { buildRenderedPageWithoutUnlockSemanticRelevanceApplications } from './cross-skill-rendered-page-without-unlock-evidence-source-scoped-semantic-relevance-application-lib.mjs';
...
const policyFile = 'platform/policies/cross-skill-rendered-page-without-unlock-evidence-source-scoped-semantic-relevance-application-v1.json';
...
if (!queueDirectory || !decisionDirectory) {
  console.log(JSON.stringify({
    contract: 'sensum.cross-skill-rendered-page-without-unlock-evidence-source-scoped-semantic-relevance-application-audit.v1',
    accepted: false,
  ...
  try {
    ...
    const built = buildRenderedPageWithoutUnlockSemanticRelevanceApplications({
    ...
    if (!built.audit.publishable) {
      ...
      const source = {
        kind: 'explicit_human_decision_bound_source_scoped_semantic_relevance_application_without_downstream_identity_or_optimizer_promotion',
      ...
      console.log(JSON.stringify({
        ...
        coverage: {
          ...
          relevantAppliedCount: report.applicationCoverage.relevantAppliedCount,
          notRelevantAppliedCount: report.applicationCoverage.notRelevantAppliedCount,
          ambiguousAppliedCount: report.applicationCoverage.ambiguousAppliedCount,
          ...
          reconciliationComplete: report.reconciliationComplete,

...
function vectorGroupDetail(vectors,target){
  ...
  let blockers=status==='mechanical_model_gap'?(mechanical.length?mechanical:['mechanical_model_incomplete']):[...new Set(coverages.flatMap(x=>x.blockers).filter(x=>x!=='entry_level_above_target'))];

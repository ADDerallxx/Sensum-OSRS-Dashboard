...
URLs, source hashes, and byte counts aligned. The shard spans 64 main, one
project, 159 file, and one calculator page and preserves 211,541 source bytes,
679 root templates, 74 direct categories, 186 lead paragraphs, and 304 headings.
Nineteen canonical shards are observed to form one exact, gap-free, disjoint
ordinal range from 1 through 4,725 with 4,725 unique signature keys and no
unexpected records. No semantic review, unlock, canonical identity, activity,
repeatability, mechanics, automatic verification, or optimizer promotion was
created. All 272 regression tests pass. Because individual shard audits
deliberately cannot certify population completeness, the next checkpoint must
durably consolidate and revalidate all nineteen shards before the full source-
signature population is promoted to complete.

Official Wiki target-source signatures are now captured for queue ordinals
4,251–4,500. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 59 main, 186 file, one
template, and four Bucket-namespace pages and preserves 242,071 source bytes,
660 root templates, 35 direct categories, 147 lead paragraphs, and 322 headings.
Eighteen canonical shards now form one exact, gap-free, disjoint ordinal range
from 1 through 4,500 with 4,500 unique signature keys. Cumulative coverage is
4,500 of 4,725, with 225 still pending. No semantic review, unlock, canonical
identity, activity, repeatability, mechanics, automatic verification, or
optimizer promotion was created. All 272 regression tests pass. The next
checkpoint should collect the final queue ordinals 4,501–4,725 while continuing
to treat full-population source coverage as incomplete.
...
and one category page and preserves 242,426 source bytes, 707 root templates, 72
direct categories, 116 lead paragraphs, and 308 headings. Sixteen canonical
shards now form one exact, gap-free, disjoint ordinal range from 1 through 4,000
with 4,000 unique signature keys. Cumulative coverage is 4,000 of 4,725, with
725 still pending. No semantic review, unlock, canonical identity, activity,
repeatability, mechanics, automatic verification, or optimizer promotion was
created. All 272 regression tests pass. The next checkpoint should collect queue
ordinals 4,001–4,250 while continuing to treat full-population source coverage
as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
3,501–3,750. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 44 main, 202 file, three
template, and one category page and preserves 286,475 source bytes, 601 root
templates, 57 direct categories, 143 lead paragraphs, and 264 headings. Fifteen
canonical shards now form one exact, gap-free, disjoint ordinal range from 1
through 3,750 with 3,750 unique signature keys. Cumulative coverage is 3,750 of
4,725, with 975 still pending. No semantic review, unlock, canonical identity,
activity, repeatability, mechanics, automatic verification, or optimizer
promotion was created. All 272 regression tests pass. The next checkpoint should
collect queue ordinals 3,751–4,000 while continuing to treat full-population
source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
3,251–3,500. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 43 main, one project, 203 file,
one template, and two calculator pages and preserves 244,128 source bytes, 625
root templates, 42 direct categories, 110 lead paragraphs, and 280 headings.
Fourteen canonical shards now form one exact, gap-free, disjoint ordinal range
from 1 through 3,500 with 3,500 unique signature keys. Cumulative coverage is
3,500 of 4,725, with 1,225 still pending. No semantic review, unlock, canonical
identity, activity, repeatability, mechanics, automatic verification, or
optimizer promotion was created. All 272 regression tests pass. The next
checkpoint should collect queue ordinals 3,501–3,750 while continuing to treat
full-population source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
3,001–3,250. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 59 main, one project, 186 file,
and four category pages and preserves 181,302 source bytes, 787 root templates,
56 direct categories, 232 lead paragraphs, and 266 headings. Thirteen canonical
shards now form one exact, gap-free, disjoint ordinal range from 1 through 3,250
with 3,250 unique signature keys. Cumulative coverage is 3,250 of 4,725, with
1,475 still pending. No semantic review, unlock, canonical identity, activity,
repeatability, mechanics, automatic verification, or optimizer promotion was
created. All 272 regression tests pass. The next checkpoint should collect queue
ordinals 3,251–3,500 while continuing to treat full-population source coverage
as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
2,751–3,000. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 28 main, 220 file, and two
category pages and preserves 211,534 source bytes, 510 root templates, 22 direct
categories, 66 lead paragraphs, and 149 headings. Twelve canonical shards now
form one exact, gap-free, disjoint ordinal range from 1 through 3,000 with 3,000
unique signature keys. Cumulative coverage is 3,000 of 4,725, with 1,725 still
pending. No semantic review, unlock, canonical identity, activity,
repeatability, mechanics, automatic verification, or optimizer promotion was
created. All 272 regression tests pass. The next checkpoint should collect queue
ordinals 3,001–3,250 while continuing to treat full-population source coverage
as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
2,501–2,750. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 49 main and 201 file pages and
preserves 184,391 source bytes, 730 root templates, 88 direct categories, 142
lead paragraphs, and 240 headings. Eleven canonical shards now form one exact,
gap-free, disjoint ordinal range from 1 through 2,750 with 2,750 unique signature
keys. Cumulative coverage is 2,750 of 4,725, with 1,975 still pending. No
semantic review, unlock, canonical identity, activity, repeatability, mechanics,
automatic verification, or optimizer promotion was created. All 272 regression
tests pass. The next checkpoint should collect queue ordinals 2,751–3,000 while
continuing to treat full-population source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
2,251–2,500. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 220 main, twenty-nine file, and
one category page and preserves 2,480,059 source bytes, 2,378 root templates,
246 direct categories, 581 lead paragraphs, and 2,150 headings. Ten canonical
shards now form one exact, gap-free, disjoint ordinal range from 1 through 2,500
with 2,500 unique signature keys. Cumulative coverage is 2,500 of 4,725, with
2,225 still pending. No semantic review, unlock, canonical identity, activity,
repeatability, mechanics, automatic verification, or optimizer promotion was
created. All 272 regression tests pass. The next checkpoint should collect queue
ordinals 2,501–2,750 while continuing to treat full-population source coverage
as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
2,001–2,250. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 230 main, twelve file, seven
category, and one calculator page and preserves 2,735,068 source bytes, 2,882
root templates, 219 direct categories, 660 lead paragraphs, and 2,283 headings.
Nine canonical shards now form one exact, gap-free, disjoint ordinal range from
1 through 2,250 with 2,250 unique signature keys. Cumulative coverage is 2,250
of 4,725, with 2,475 still pending. No semantic review, unlock, canonical
identity, activity, repeatability, mechanics, automatic verification, or
optimizer promotion was created. All 272 regression tests pass. The next
checkpoint should collect queue ordinals 2,251–2,500 while continuing to treat
full-population source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
1,751–2,000. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 217 main, twenty-nine file, and
four calculator pages and preserves 1,547,395 source bytes, 2,297 root templates,
148 direct categories, 634 lead paragraphs, and 1,399 headings. Eight canonical
shards now form one exact, gap-free, disjoint ordinal range from 1 through 2,000
with 2,000 unique signature keys. Cumulative coverage is 2,000 of 4,725, with
2,725 still pending. No semantic review, unlock, canonical identity, activity,
repeatability, mechanics, automatic verification, or optimizer promotion was
created. All 272 regression tests pass. The next checkpoint should collect queue
ordinals 2,001–2,250 while continuing to treat full-population source coverage
as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
1,501–1,750. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 228 main, nineteen file, two
module, and one calculator page and preserves 1,295,413 source bytes, 2,096 root
templates, 112 direct categories, 723 lead paragraphs, and 1,222 headings. Seven
canonical shards now form one exact, gap-free, disjoint ordinal range from 1
through 1,750 with 1,750 unique signature keys. Cumulative coverage is 1,750 of
4,725, with 2,975 still pending. No semantic review, unlock, canonical identity,
activity, repeatability, mechanics, automatic verification, or optimizer
promotion was created. All 272 regression tests pass. The next checkpoint should
collect queue ordinals 1,751–2,000 while continuing to treat full-population
source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
1,251–1,500. The first two collection attempts rejected atomically and wrote no
output because `Guide:Clue Juggling` redirected from an observed main-namespace
link to the Wiki's Guide namespace. The collector now preserves that distinction
generically: an exact redirected identity may resolve across namespaces, while
an unredirected namespace mismatch still fails with the affected queue key.
Page ID, revision, timestamp, resolved title, URL, source hash, and byte checks
remain strict. Two corrected exact-revision fetches produced the same 250-record
hash, and a current-code re-fetch of ordinals 1–250 reproduced their original
content hash. The shard spans 234 main, twelve file, three category, and one
Guide page and preserves 1,144,457 source bytes, 2,037 root templates, 132
direct categories, 581 lead paragraphs, and 1,112 headings. Six canonical
shards now form one exact, gap-free, disjoint ordinal range from 1 through 1,500
with 1,500 unique signature keys. Cumulative coverage is 1,500 of 4,725, with
3,225 still
pending. No semantic or optimizer promotion was created. All 272 regression
tests pass. The next checkpoint should collect queue ordinals 1,501–1,750.

Official Wiki target-source signatures are now captured for queue ordinals
1,001–1,250. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 238 main, ten file, one
category, and one module page and preserves 1,366,537 source bytes, 2,402 root
templates, 146 direct categories, 625 lead paragraphs, and 1,316 headings. The
first five canonical shards now form one exact, gap-free, disjoint ordinal range
from 1 through 1,250 with 1,250 unique signature keys. Cumulative coverage is
1,250 of 4,725, with 3,475 still pending. No semantic review, unlock, canonical
identity, activity, repeatability, mechanics, automatic verification, or
optimizer promotion was created. All 270 regression tests pass. The next
checkpoint should collect queue ordinals 1,251–1,500 while continuing to treat
full-population source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
751–1,000. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 202 main, one project, 44 file,
one module, and two calculator pages and preserves 1,288,329 source bytes, 2,036
root templates, 129 direct categories, 611 lead paragraphs, and 1,016 headings.
The first four canonical shards now form one exact, gap-free, disjoint ordinal
range from 1 through 1,000 with 1,000 unique signature keys. Cumulative coverage
is 1,000 of 4,725, with 3,725 still pending. No semantic review, unlock,
canonical identity, activity, repeatability, mechanics, automatic verification,
or optimizer promotion was created. All 270 regression tests pass. The next
checkpoint should collect queue ordinals 1,001–1,250 while continuing to treat
full-population source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
501–750. Two independent exact-revision fetches produced the same 250-record
hash, and all page IDs, revisions, timestamps, titles, namespaces, URLs, source
hashes, and byte counts aligned. The shard spans 227 main, one project, 19 file,
two category, and one calculator page and preserves 1,778,609 source bytes,
2,500 root templates, 156 direct categories, 599 lead paragraphs, and 1,598
headings. The first three canonical shards now form one exact, gap-free,
disjoint ordinal range from 1 through 750 with 750 unique signature keys.
Cumulative coverage is 750 of 4,725, with 3,975 still pending. No semantic
review, unlock, canonical identity, activity, repeatability, mechanics,
automatic verification, or optimizer promotion was created. All 270 regression
tests pass. The next checkpoint should collect queue ordinals 751–1,000 while
continuing to treat full-population source coverage as incomplete.

Official Wiki target-source signatures are now captured for queue ordinals
251–500. Both independent exact-revision fetches produced the same 250-record
hash, and all 250 page IDs, revisions, timestamps, titles, namespaces, URLs,
source hashes, and byte counts aligned. This shard spans 233 main, one talk,
seven file, and nine category pages and preserves 1,987,281 source bytes, 3,132
root templates, 174 direct categories, 748 lead paragraphs, and 1,976 headings.
Together, the first two canonical shards form one exact, gap-free, disjoint
ordinal range from 1 through 500 with 500 unique signature keys. Cumulative
coverage is therefore 500 of 4,725, with 4,225 still pending. No semantic
review, unlock, canonical identity, activity, repeatability, mechanics,
automatic verification, or optimizer promotion was created. All 270 regression
tests pass. The next checkpoint should collect queue ordinals 501–750 while
continuing to treat full-population source coverage as incomplete.
...
The reference-collection member source-evidence domain is now the fifth
registered PostgreSQL evidence adapter. It revalidates the exact audit,
manifest, embedded audit, raw NDJSON, all record hashes, 69 fetched revision
identities, collection contexts, source alignment, structural coverage, and
closed semantic gates before any database attempt. The admitted snapshot is
pinned to hash
`041c7a75ee9fa3b7b089ec651b3d948856a43abd1fc9e28775f47a295349298f`
and audit hash
`ea17bcb1c019a4d4eb099a8974e1fb7a3e046c5409a09458269f1a975c0d0d06`.
All 69 records and exact Wiki revisions are retained losslessly. Fifty-four
supported activity infoboxes and 15 missing-infobox cases remain distinct;
zero skill keys are inferred from collection membership or page text.

A pre-change backup was created at
`.platform-local/backups/sensum-v4-20260906-135238.dump` (4,876,591 bytes,
SHA-256 `c32b6fe9f34f3d50807cfffe1e6ec273614b42ad4dc27f59d3d0b8897bb86858`).
The adapter inserted 69 raw records, 69 candidate statements, and 69 direct
lineage links. Of the 69 source identities, 48 were new and 21 were reused
without changing acquisition timestamps. Two complete five-domain batches
reproduced input-set hash
`3d0ebec1b71836c1b46c937266f00c2da82dbdd6931cac53198e4802b1c5f876`
and stable catalog counts. The catalog now reconciles 161 revision-pinned
sources, 124 raw records, 4,868 candidate statements, and 4,868 direct lineage
rows with zero unlinked or optimizer-eligible statements. Evidence and lineage
aggregate hashes are `8d5021bbec346ed6fd9509d50d29f6e9` and
`e20ed48c4a5cdf798961a3acd384dd35`. The shared Wise Old Man revision is one
source identity linked to three exact domain snapshots. Registry coverage is
now 5/28, with 11 adapter-ready and 12 blocked unregistered datasets.

All 214 V4 test scripts pass. This checkpoint creates no canonical entity or
activity identity, repeatability decision, skill assignment, requirements,
mechanics, complete-universe claim, verified fact, optimizer promotion,
...
The collection-member repeatability review-evidence domain is now the eighth
registered PostgreSQL evidence adapter. Before any database attempt, it
revalidates the exact audit, manifest, embedded audit, raw NDJSON, all eleven
signal-policy definitions, record-derived counts, complete linked-source scans,
exact collection-row scans, source-located signals, canonical-activity identity
consistency, source-page/revision alignment, and every closed semantic gate.
The three lossless records preserve Archery Competition, Aldarin Vineyard, and
Wise Old Man tasks as previously reviewed canonical activity identities while
retaining four repeatability observations as review candidates. No
repeatability verdict, member expansion, mechanic, skill assignment, verified
fact, or optimizer eligibility is inferred. The snapshot and audit remain
pinned to hashes
`c36112e648d559cc02a5e16b1cc5da6e19406f7bf944c48e981cb121d9421f4a`
and `182fca5b25fca15c6721eb5d41f36553522d567d0420846201146ae7bb14dadb`.

A validated pre-change backup was created at
`.platform-local/backups/sensum-v4-20260906-144652.dump` (5,241,048 bytes,
306 readable archive lines, SHA-256
`5d4d4b458bca4ed579626fab499a1c5bd675a1bda3f5de47fe238e730285ab4c`).
The adapter added three raw records, three candidate statements, and three
direct lineage links while reusing all three exact linked-source identities
without changing their acquisition timestamps. Its deliberate failure probe
rolled back cleanly, immediate reapplication was idempotent, and two complete
eight-domain batches reproduced input-set hash
`6973cb86891e0be9afee5fc0086f602893a168190461f9794e241329139b1e4a`
with stable catalog counts. The catalog now reconciles 161 revision-pinned
sources, 133 raw records, 4,877 candidate statements, and 4,877 direct lineage
rows with zero unlinked or optimizer-eligible statements. Evidence and lineage
aggregate hashes are `2966703882c218d9986ea807b8fe1f37` and
`227669fb9fad26cf7d2c60e0b0443039`. The shared Wise Old Man revision remains
one source identity and now links to six exact domain snapshots. Registry
coverage is 8/28, with eight adapter-ready and 12 blocked unregistered datasets.

All 217 V4 test scripts pass. This checkpoint creates no reviewed
repeatability verdict, member-expansion decision, requirement, XP, timing,
mechanic, complete-universe claim, verified-best authorization, production
mutation, or V3 change. The next breadth-selected adapter candidate is the
three-record
`activity-reference-collection-member-unresolved-subject-relationship-evidence`
domain, which must retain its unresolved relationship and semantic blockers
during PostgreSQL admission.

The unresolved-subject relationship review-evidence domain is now the ninth
registered PostgreSQL evidence adapter. Before any database attempt, it
revalidates the exact audit, manifest, embedded audit, raw NDJSON, upstream
routing and source-signature snapshots, the seven-channel evidence policy,
record-derived coverage counts, all 73 source-authored links, all 65
main-namespace relationship candidates, all three collection-row link
candidates, both linked-subject and collection-source provenance layers, and
every closed semantic gate. The three lossless records retain the exact Target
(Ranging Guild), Vineyard foreman, and Wise Old Man tasks revisions together
with their common Minigames collection revision. No relationship verdict,
canonical identity, repeatability result, member expansion, mechanic, skill
assignment, verified fact, or optimizer eligibility is inferred. The snapshot
and audit remain pinned to hashes
`7da73b0f085425ec41429042159cf7720c3819eff13e387f2d235fb099a09b7f`
and `f55f05a9d27a352e01828b6aaff6733e68e7d9813b782435787a2a36254d10ec`.

A validated pre-change backup was created at
`.platform-local/backups/sensum-v4-20260906-150555.dump` (5,271,607 bytes,
306 readable archive lines, SHA-256
`1674113e5fdd38c1c48d44258eebc0dfa22a3f1dba36dca3dcadc39d30761660`).
The adapter added three raw records, three candidate statements, and three
direct lineage links while reusing all four exact source identities without
changing their acquisition timestamps. Its deliberate failure probe rolled
back cleanly, immediate reapplication was idempotent, and two complete
nine-domain batches reproduced input-set hash
`ca8889cbf2f799c8772295fb6786a8a88f3b6bc25c9deb21a1d14e35945030bf`
with stable catalog counts. The catalog now reconciles 161 revision-pinned
sources, 136 raw records, 4,880 candidate statements, and 4,880 direct lineage
rows with zero unlinked or optimizer-eligible statements. Evidence and lineage
aggregate hashes are `2bb812daf8b64a0f4c9f44236f0fa5ff` and
`a432dacfd07493af62a3386e23f5b008`. The shared Wise Old Man revision remains
one source identity and now links to seven exact domain snapshots. Registry
coverage is 9/28, with seven adapter-ready and 12 blocked unregistered
datasets.

All 218 V4 test scripts pass. This checkpoint creates no reviewed relationship
or identity verdict, repeatability or member-expansion decision, requirement,
XP, timing, mechanic, complete-universe claim, verified-best authorization,
production mutation, or V3 change. The next breadth-selected adapter candidate
is the two-record

...
| Combat Growth | Corrected | `SKILL_THRESHOLD`. The interface targets the next milestone at 70, 85, 100, 110, 120, or 126 and advances automatically when one is reached. The long-term endpoint remains 126 without presenting it as the immediate target. | Stats |
